    ...
    class ControlIVPage
    {
        ...
        public void HistoryShow(string pt_id)
        {
            ...
            foreach (EyeIV tmpIV in ivList)
            {
                ...
                r["日付"] = tmpIV.IVDate.Insert(4, "/").Insert(7, "/");
        ...
        public void HistoryFormat()
        {
            if (DSet != null && DSet.Tables.Contains("IV"))
            {
                ...
                FP.IVHistoryView.Columns["日付"].DisplayIndex = 0;
                ...
                FP.IVHistoryView.Columns["時刻"].DisplayIndex = 1;
                ...
                FP.IVHistoryView.Columns["入力者"].DisplayIndex = 3;
                FP.IVHistoryView.Columns["内容"].DisplayIndex = 2;
